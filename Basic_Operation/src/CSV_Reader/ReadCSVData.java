...
public class ReadCSVData {
	 ...
	 * "D:\\EclipseWorkSpace\\CSVOperations\\results.csv"; private static final
	 * String CSV_FILE_CUSTOM_SEPERATOR =
	 ...
	 * 
	 * // create csvReader object passing // filereader as parameter CSVReader
	 ...
	 * e) { e.printStackTrace(); } }
	 * 
	 * public static void readAllDataAtOnce(String file) { try {
	 * 
	 * // Create an object of filereader class // with CSV file as a parameter.
	 * FileReader filereader = new FileReader(file);
	 * 
	 * // create csvReader object // and skip first Line CSVReader csvReader = new
	 * CSVReaderBuilder(filereader).withSkipLines(1).build(); List<String[]> allData
	 * = csvReader.readAll();
	 * 
	 ...
	 * e) { e.printStackTrace(); } }
	 * 
	 * public static void readDataFromCustomSeperator(String file) { try { // Create
	 * object of filereader // class with csv file as parameter. FileReader
	 * filereader = new FileReader(file);
	 * 
	 * // create csvParser object with // custom seperator semi-colon CSVParser
	 * parser = new CSVParserBuilder().withSeparator(';').build();
	 * 
	 * // create csvReader object with // parameter filereader and parser CSVReader
	 * csvReader = new CSVReaderBuilder(filereader).withCSVParser(parser).build();
	 * 
	 * // Read all data at once List<String[]> allData = csvReader.readAll();
	 * 
	 * // print Data for (String[] row : allData) { for (String cell : row) {
	 * System.out.print(cell + "\t"); } System.out.println(); } } catch (Exception
	 * e) { e.printStackTrace(); } }
